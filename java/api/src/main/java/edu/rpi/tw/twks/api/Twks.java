 ...
 */
public interface Twks extends AdministrationApi, AutoCloseable, ChangeObservableApi, GetAssertionsApi, IsEmptyApi, NanopublicationCrudApi, NanopublicationCrudObservableApi {
    /**
